  ...
  return (
    <>
      ...
      <section className="privacy-page">
        ...
        <h1 className="privacy-details">
          This Privacy Policy describes how your personal information is
          collected, used, and shared when you visit or make a purchase from
          www.playmoremama.com (the “Site”). Personal information we collect
          ...
          record information about how you browse the Site. - We use services
          such as Google Analytics and Facebook Pixels to better understand our
          customers. Additionally when you make a purchase or attempt to make a
          ...
          talking both about Device Information and Order Information. How do we
          use your personal information? We use the Order Information that we
          ...
          described above. For example, we use GoDaddy to power our online
          store--you can read more about how GoDaddy uses your Personal
          Information here: https://ae.godaddy.com/agreements/privacy. We also
          ...
          rights. Behavioral advertising As described above, we use your
          ...
          more information about how targeted advertising works, you can visit
          ...
          information. Changes We may update this privacy policy from time to
          time in order to reflect, for example, changes to our practices or for
          other operational, legal or regulatory reasons. Minors The Site is not
          intended for individuals under the age of 13 Contact us For more
          ...
          playmoremama@gmail.com or by mail using the details provided below:
          play.more.mama P.O. BOX 3282, MONTEREY, CA, 93942, United States
        </h1>
      </section>
      <MainFooter />
    </>
