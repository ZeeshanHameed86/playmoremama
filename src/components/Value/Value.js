    ...
    <section className="value">
      ...
      <div className="value-details section-center">
        <div className="value-1">
          <LazyLoadImage src={jar1} alt="" className="img-1" />
          <LazyLoadImage src={bottle1} alt="" className="img-2" />
          <LazyLoadImage src={jar2} alt="" className="img-3" />
          <h1 className="bold">
        ...
        <div className="value-2">
          <LazyLoadImage src={jar3} alt="" className="img-4" />
          <LazyLoadImage src={jar4} alt="" className="img-5" />
          <h1>
        ...
        <div className="value-3">
          <LazyLoadImage src={bottle2} alt="" className="img-6" />
          <LazyLoadImage src={bottle3} alt="" className="img-7" />
          <h1>
            Carefully curated products created for meaningful hands-on-learning.
          </h1>
        </div>
        <div className="value-4">
          <LazyLoadImage src={jar5} alt="" className="img-8" />
          <LazyLoadImage src={dice} alt="" className="img-9" />
          <h1>
            And travel-size,
